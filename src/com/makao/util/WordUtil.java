...
public class WordUtil {  
    ...
    public static HashSet<String> getTags(String article,Integer a,Integer n,HashSet<String> tagdic) throws IOException {  
        ...
        //String[] keyWords=new String[n];                    //设置将要输出的关键字数组空间  
        for(int i=0; i< list.size(); i++) {                  //循环排序后的数组  
            if (i<n && tagdic.contains(list.get(i).getKey())) {                                       //判断个数  
            	tags.add(list.get(i).getKey());           //设置关键字进入数组  
            }  
        }  
        return tags;  
    } 
    ...
    public static HashSet<String> getTags(String article,HashSet<String> tagdic) throws IOException{  
        return getTags(article,QUANTITY,NUM,tagdic);  
    } 
